...
//FetchData()
  ...
  return (
    ...
    <div className="section-title tab-manu">
      ...
      <ul className="nav nav-tabs" role="tablist">
        <li role="presentation">
          <a className="active" href="#hot-jobs" data-toggle="tab">
            Hot Jobs
          </a>
        </li>
        <li role="presentation">
        ...
        <li role="presentation">
          <a href="#popular-jobs" data-toggle="tab">
            Popular Jobs
          </a>
        </li>
      </ul>
    ...
    <div className="tab-content">
      <div role="tabpanel" className="tab-pane fade in active show" id="hot-jobs">
       {content&&content.map((list, id)=>
          <JobItemCard image={list.image} title={list.title} company={list.company} address={list.address} max_salary={list.max_salary} min_salary={list.min_salary} office={list.office} jobId={list.id} key={id}/>
        )}
      </div>
